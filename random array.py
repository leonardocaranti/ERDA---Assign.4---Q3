...
A = np.array([[random.randint(26,61),58.37,17.40,880,8800,268,233000,7,2,8], 
              [60.30,63.69,16.80,880,8200,292,23300,8,2,5], 
...
boeingvariant = np.array([35.80,39.47,12.55,842,5436,189,79016,3,2,5])
